...
<div class="container mt-4 mb-5">
    ...
    <div class="row justify-content-center g-4 mb-5">
        ...
        <div class="col-lg-6 col-md-8 col-12">
            ...
            <p class="text-center mt-2 text-muted">Přehled stanic na mapě</p>
        </div>
        ...
        <div class="col-lg-4 col-md-4 col-8 d-flex flex-column align-items-center justify-content-center">
            ...
            <p class="text-center mt-2 lead">Vlajka země</p>
        </div>
                ...
                <div class="card shadow-sm h-100 border-start border-secondary border-5">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled small">
                            <li><i class="fas fa-compass me-2 text-primary"></i> **Šířka:** <?= $row->geo_latitude ?></li>
                            <li><i class="fas fa-compass me-2 text-primary"></i> **Délka:** <?= $row->geo_longtitude ?></li>
                            <li><i class="fas fa-mountain me-2 text-primary"></i> **Výška:** <?= $row->height ?> m</li>
                            <li><i class="fas fa-briefcase me-2 text-primary"></i> **Operátor:** <?= $row->operator ?></li>
                        </ul>
                        
                        <a href="<?= base_url('data/' . $row->S_ID); ?>" class="btn btn-sm btn-outline-primary mt-2 ">
